...
// TODO : id system for voices to prevent ghosting and allow overlap
    void addVoice(const int16_t* sample,int32_t sample_length, int8_t note, uint32_t pitch_bend, int8_t volume,int8_t channel , bool looping);
    void removeVoice(int8_t channel, int8_t note);
